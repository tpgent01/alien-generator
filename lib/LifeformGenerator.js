...
class LifeformGenerator {
  ...
  initializeLifeformGenerator(alienName) {
    if(alienName) {
      this.lifeform.name = alienName
    } else {
      this.lifeform.name = this.generateName();
    }
    this.lifeform.disposition = this.generateDisposition();
    this.lifeform.birth = this.generateBirth();
    this.lifeform.reason = this.generateReason();
    this.lifeform.backstory = this.generateBackstory();
    this.lifeform.locomotion = this.generateLocomotion();
    ...
    return JSON.stringify(this.lifeform, null, 2)
  }
...
"lifeform": ${lifeform}
  ...
  generateBackstory() {
    return `${
    this.lifeform.name
  } ${this.lifeform.disposition} It ${this.lifeform.birth}. ${
    this.lifeform.name
  } ${this.lifeform.reason}`;
  }
  ...
  generateHead() {
    ...
    if (chance >= 1 && chance <= 2) {
      ...
      if (chance >= 1 && chance <= 3) {
        ...
        return `'s ${this.generateSize()}Bison-like Head ${this.generateNeck()}`;
      } else if (chance >= 10 && chance <= 12) {
        return `'s ${this.generateSize()}Beetle-like Head ${
          this.generateNeck()
        }`;
      } else if (chance >= 13 && chance <= 15) {
        return `'s ${this.generateSize()}Bear-like Head ${this.generateNeck()}`;
      } else if (chance >= 16 && chance <= 18) {
        return `'s ${this.generateSize()}Monkey-like Head ${
          this.generateNeck()
        }`;
      } else if (chance >= 19 && chance <= 21) {
        return `'s ${this.generateSize()}Rhino-like Head ${this.generateNeck()}`;
      } else if (chance >= 22 && chance <= 24) {
        return `'s ${this.generateSize()}Camel-like Head ${this.generateNeck()}`;
        ...
        return `'s ${this.generateSize()}Mole-like Head ${this.generateNeck()}`;
        ...
        return `'s ${this.generateSize()}Hippo-like Head ${this.generateNeck()}`;
      } else if (chance >= 43 && chance <= 45) {
        return `'s ${this.generateSize()}Eagle-like Head ${this.generateNeck()}`;
      } else if (chance >= 46 && chance <= 48) {
        return `'s ${this.generateSize()}Raccoon-like Head ${
          this.generateNeck()
        }`;
      } else if (chance >= 49 && chance <= 51) {
        return `'s ${this.generateSize()}Horse-like Head ${this.generateNeck()}`;
      } else if (chance >= 52 && chance <= 54) {
        return `'s ${this.generateSize()}Koala-like Head ${this.generateNeck()}`;
      } else if (chance >= 55 && chance <= 57) {
        return `'s ${this.generateSize()}Centipede-like Head ${
          this.generateNeck()
        }`;
      } else if (chance >= 58 && chance <= 60) {
        return `'s ${this.generateSize()}Wasp-like Head ${this.generateNeck()}`;
      } else if (chance >= 61 && chance <= 63) {
        return `'s ${this.generateSize()}Fly-like Head ${this.generateNeck()}`;
        ...
        return `'s ${this.generateSize()}Shark-like Head ${this.generateNeck()}`;
        ...
        return `'s ${this.generateSize()}Frog-like Head ${this.generateNeck()}`;
      } else if (chance >= 85 && chance <= 87) {
        return `'s ${this.generateSize()}Dragon-like Head ${
          this.generateNeck()
        }`;
      } else if (chance >= 88 && chance <= 90) {
        return `'s ${this.generateSize()}Duck-like Head ${this.generateNeck()}`;
        ...
        return `'s Pig-like Head  ${this.generateNeck()}`;
      }
    } else if (chance >= 3 && chance <= 5) {
      let chance = random.die(6);
      if (chance === 1) {
        ...
        return `'s ${this.generateSize()}Humanoid Head ${this.generateNeck()}`;
      } else {
  ...
  generateEars() {
    ...
    if (chance >= 1 && chance <= 12) {
      ...
      return `${this.generateSize()}Earholes instead of`;
    } else if (chance >= 76 && chance <= 88) {
  ...
  generateDisposition() {
    ...
    if (chance >= 1 && chance <= 7) {
      ...
      return `tends to rush into situations without thinking it all the way through.`;
    } else {
