...
class LifeformGenerator {
    ...
    initializeLifeformGenerator() {
        ...
        this.lifeform.physicalDescription = `${this.lifeform.name} is a ${this.lifeform.locamotion} that ${this.generateUpperMadLib()} using it's ${this.lifeform.upperAppendageType}. ${this.lifeform.name}${this.lifeform.head} ${this.lifeform.facialFeatures}. ${this.generateFaceMadLib()} it's ${this.lifeform.eyes} eyes, ${this.lifeform.nose}, ${this.lifeform.ears} ears, and ${this.lifeform.mouth}! ${this.lifeform.name}'s epidermis is ${this.lifeform.skin}, but most notably ${this.lifeform.name} has ${this.lifeform.otherFeatures}.`;
